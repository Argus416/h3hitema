...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\argus\Desktop\h3hitema\Python\FastAPI\fastapi_static_vir'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\argus\Desktop\h3hitema\Python\FastAPI\fastapi_static_vir\Scripts\deactivate.nu'
